...
import static com.example.tofi.common.persistance.domain.user.Privilege.PrivilegeObject.*;
import static com.example.tofi.common.persistance.domain.user.Privilege.PrivilegeType.*;
